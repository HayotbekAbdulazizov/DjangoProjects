...
class News(models.Model):
    ...
    slug = models.SlugField('*', max_length=100, unique=True)
    category = models.ForeignKey(Brand, on_delete=CASCADE, related_name='news')
...
class Car(models.Model):
	...
	price = models.CharField('Narxi', max_length=20, blank=True)
	old_price = models.CharField('Eski Narxi', max_length=30, blank=True)
